...
<a className="text-primary px-4 font-bold hover:underline cursor-pointer">Services</a>
<a className="text-primary px-4 font-bold hover:underline cursor-pointer">information</a>
        </div>
