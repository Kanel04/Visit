...
<div>
<div class="overlay modal-trigger  absolute w-full h-screen bg-[#333333d3]">
<div className="   bg-zinc-200 opacity-1 fixed inset-0 z-50   ">

<div className="flex h-screen justify-center items-center ">

    <div className="flex-col justify-center  bg-primary py-12 px-24 border-4 border-sky-500 rounded-xl ">
